package ir.tiroon.foundation.paillier;

//https://www.csee.umbc.edu/~kunliu1/research/Paillier.java
/**
...
/**
 * Paillier3 Cryptosystem <br><br>
 * References: <br>
 * [1] Pascal Paillier3, "Public-Key Cryptosystems Based on Composite Degree Residuosity Classes," EUROCRYPT'99.
 ...
 *
 * [2] Paillier3 cryptosystem from Wikipedia.
...
public class Paillier2 {
    ...
    /**
     * Constructs an instance of the Paillier3 cryptosystem.
     * @param bitLengthVal number of bits of modulus
     * @param certainty The probability that the new BigInteger represents a prime number will exceed (1 - 2^(-certainty)). The execution time of this constructor is proportional to the value of this parameter.
     */
    public Paillier2(int bitLengthVal, int certainty) {
        KeyGeneration(bitLengthVal, certainty);
    }

    /**
     * Constructs an instance of the Paillier3 cryptosystem with 512 bits of modulus and at least 1-2^(-64) certainty of primes generation.
     */
    public Paillier2() {
...
/* instantiating an object of Paillier3 cryptosystem*/
        Paillier2 paillier = new Paillier2();
