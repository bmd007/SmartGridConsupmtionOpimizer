...
import ir.tiroon.foundation.service.userManagement.RoleServices;
...
public class Controllers {
    ...
    public String test(Model model) {
        ...
        model.addAttribute("users", userServices.getEntityList());
        return "/test";
    }
    ...
    public String logoutPage(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (auth != null) {
            //new SecurityContextLogoutHandler().logout(request, response, auth); use this line instead when no remember-me exists
